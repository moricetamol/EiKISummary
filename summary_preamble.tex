...
% Title
%----------------------------------------------
\def\MainColor{codepurple} % Sets the main color of the template
\usepackage{titling}
...
\tcbset{
    ...
    definitionbox/.style={
        purplebox % Change these to the colors you want your defboxes to be
    },
    mathematicsbox/.style={
        greenbox % Change these to the colors you want your mathboxes to be
    },
    codingbox/.style={
        orangebox % Change these to the colors you want your code boxes to be
    }
}
